...
open class OldPurchaseService: NSObject  {
...
extension OldPurchaseService: SKProductsRequestDelegate {
...
extension OldPurchaseService: SKPaymentTransactionObserver {
    ...
    public func paymentQueue(_ queue: SKPaymentQueue, shouldAddStorePayment payment: SKPayment, for product: SKProduct) -> Bool {
        let result = OldPurchaseService.canMakePayments()
        if !result {
